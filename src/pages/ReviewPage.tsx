...
import { Repeat, CheckCircle, AlertTriangle, BookOpen, ArrowRight, PieChart, BookText, Star } from 'lucide-react';
import { db } from '../db';
      ...
      {reviewingWord ? (
        ...
        <Tabs defaultValue="flashcards">
          <Tabs.List>
            ...
            <Tabs.Trigger value="starred" icon={<Star size={16} />}>Starred</Tabs.Trigger>
